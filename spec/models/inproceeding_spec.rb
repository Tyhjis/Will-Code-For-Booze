...
describe Inproceeding do
  ...
  it "is not saved if required field year not present" do
    inproceeding = Inproceeding.create author:"Author", title:"Title", booktitle:"Booktitle"
    expect(inproceeding).not_to be_valid
  end

  it "is not saved if required field booktitle not present" do
    inproceeding = Inproceeding.create author:"Author", title:"Title", year:1990
    expect(inproceeding).not_to be_valid
  end

  it "is not saved if required field title not present" do
    inproceeding = Inproceeding.create author:"Author", booktitle:"Booktitle", year:1990
    expect(inproceeding).not_to be_valid
  end

  it "is not saved if required field author not present" do
    inproceeding = Inproceeding.create title:"Title", booktitle:"Booktitle", year:1990
    expect(inproceeding).not_to be_valid
  end

  it "is saved if all required fields present" do
    inproceeding = Inproceeding.create author:"Author", title:"Title", booktitle:"Booktitle", year:1990
    expect(inproceeding).to be_valid
  end

  it "is saved with all given fields" do
    inproceeding = Inproceeding.create author:"Author", title:"Title", booktitle:"Booktitle", year:1990, publisher:"Jaska", note:"olen ihana"
    expect(inproceeding).to be_valid
